...
namespace alexsylex
{
	...
	public:
		...
		T GetSetting(const char* a_name) 
		{
			return reinterpret_cast<RE::INISettingCollection*>(this)->GetSetting(a_name); 
		}
	...
	private:
		...
		virtual void InsertSetting(RE::Setting*) {}				   // 01
		virtual void RemoveSetting(RE::Setting*) {}				   // 02
		virtual bool WriteSetting(RE::Setting*) { return false; }  // 03
		virtual bool ReadSetting(RE::Setting*) { return false; }   // 04
		virtual bool OpenHandle(bool) { return false; }			   // 05
		virtual bool CloseHandle() { return false; }			   // 06
