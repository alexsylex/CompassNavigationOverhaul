...
namespace RE
{
	...
	void GFxValue::ObjectInterface::VisitMembers(void* a_data, ObjVisitor* a_visitor, bool a_isDObj) const
	{
		...
		REL::Relocation<func_t> func{ REL::ID(80279) };
	...
	void GFxValue::ObjectInterface::VisitElements(void* a_data, ArrVisitor* a_visitor, std::uint32_t a_idx, const GFxValue& a_val) const
	{
		...
		REL::Relocation<func_t> func{ REL::ID(80278) };
	...
	{
		assert(IsObject());
		_objectInterface->VisitMembers(_value.obj, a_visitor, IsDisplayObject());
	}
	...
	void GFxValue::VisitElements(ArrayVisitor* a_visitor, std::uint32_t a_idx, std::int16_t a_count) const
	{
		assert(IsArray());
		return _objectInterface->VisitElements(_value.obj, a_visitor, a_idx, a_count);
	}

	void GFxValue::VisitElements(ArrayVisitor* a_visitor) const
	{
